    ...
    return (
        <section className="container pt-3">
            <div>
                ...
                <div className='w-auto text-center about_us_text'>
                    <p>
                        ...
                        agar lebih mudah untuk diakses oleh pengguna. Tentunya dengan menggunakan WHatWeather
            ...
            <div className="pt-3">
                <div className="g-4 row row-cols-md-2 row-cols-1 profile">
                    <div className="col">
                        <div className='card'>
            ...
            <div className="mt-5 ms-2 me-2 feature">
                <h2 className='text-center'>Kenapa WhatWeather?</h2>
                <hr></hr>
                <div className="row align-items-center">
                    <div className="col-md-7">
                        <h2>Pencarian cuaca yang mudah</h2>
